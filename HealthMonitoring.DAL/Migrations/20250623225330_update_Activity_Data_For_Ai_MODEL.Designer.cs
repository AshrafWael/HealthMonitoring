...
namespace HealthMonitoring.DAL.Migrations
{
    ...
    [Migration("20250623225330_update_Activity_Data_For_Ai_MODEL")]
    partial class update_Activity_Data_For_Ai_MODEL
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HealthMonitoring.DAL.Data.Models.AIModels.HeartRateData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthMonitoring.DAL.Data.Models.ActivityData", b =>
                {
                    ...
                    b.Property<double>("FairlyActiveMinutes")
                        .HasColumnType("float");

                    b.Property<double>("LightlyActiveMinutes")
                        .HasColumnType("float");

                    b.Property<double>("SedentaryMinutes")
                        .HasColumnType("float");

                    b.Property<double>("TotalMinutesAsleep")
                        .HasColumnType("float");
                    ...
                    b.Property<double>("VeryActiveMinutes")
                        .HasColumnType("float");
            ...
            modelBuilder.Entity("HealthMonitoring.DAL.Data.Models.CaloriesPrediction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ActivityDtataId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HealthMonitoring.DAL.Data.Models.CaloriesPrediction", b =>
                {
                    b.HasOne("HealthMonitoring.DAL.Data.Models.ActivityData", "ActivityData")
                        .WithMany()
                        .HasForeignKey("ActivityDtataId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HealthMonitoring.DAL.Data.Models.ApplicationUser", "User")
                        .WithMany("CaloriesPredictions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HealthMonitoring.DAL.Data.Models.ApplicationUser", b =>
                {
                    b.Navigation("CaloriesPredictions");
